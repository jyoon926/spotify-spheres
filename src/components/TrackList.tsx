...
export default function TrackList({ spotifyApi }: Props) {
  ...
  return (
    <div className="absolute bottom-0 left-0 p-3 flex m-h-full">
      {trackList.length > 0 &&
        <div className="border-2 p-3 flex flex-col gap-2 bg-glass backdrop-blur-md">
          <div className="w-80 flex flex-row justify-between items-center">
            ...
            {trackList.length > 0 &&
              <button className="button sm" onClick={handleCreatePlaylist}>Create playlist</button>
            }
          </div>
